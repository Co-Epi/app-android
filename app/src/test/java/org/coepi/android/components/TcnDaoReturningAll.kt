...
class TcnDaoReturningAll(private val tcns: List<ReceivedTcn>):
    TcnDao {
    override fun all(): List<ReceivedTcn> = tcns
    override fun matchTcns(start: UnixTime, end: UnixTime, tcns: Array<String>): List<ReceivedTcn> = emptyList()
